...
const inputClass = 'h-12 rounded-full border border-white/50 bg-white/85 px-5 text-base font-semibold text-[#10203a] outline-none transition placeholder:text-[#637083]/70 focus:border-[#0b5483] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-full bg-[#0b5483] px-6 text-sm font-black uppercase tracking-[0.12em] text-white shadow-[0_12px_28px_rgba(11,84,131,0.22)] transition hover:-translate-y-0.5 disabled:opacity-60'
